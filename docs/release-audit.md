...
- Formatting and clippy passed. The saved-setup replay integration passed for Wally and Git submodules (one serial test, 22.45 seconds), including direct replacement semantics and source-byte preservation during replay. Locked packaging, local CodeRabbit, reviewed-head CI, and merged-main CI are pending final evidence below. Unrelated live integrations are not rerun for this milestone.
