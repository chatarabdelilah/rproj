...
Saved-setup replay/refusal, diagnostic logging (PR #11), shared confirmed execution (PR #12), and Ratatui creation (PR #14) shipped in 0.13.0 through release PR #15. [Merged-main CI](https://github.com/chatarabdelilah/rproj/actions/runs/34181012236) passed. The release branch is deleted; the model-import experiment remains preserved. The configuration-preservation implementation is complete and merged in [PR #16](https://github.com/chatarabdelilah/rproj/pull/16), with main CI passing at `4413bb5`. Release 0.13.1 is the selected candidate. Do not repeat the implementation, republish, or move v0.13.0. Remaining alpha audit gaps stay tracked.
