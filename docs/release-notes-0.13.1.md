...
Install or update with `cargo install rproj --version 0.13.1 --locked`.

## Verification And Limits

The release includes 309 ordinary passing tests and 19 explicitly ignored tests (328 discovered). Formatting, clippy, locked packaging, reviewed-head CI, and merged-main CI passed. Studio/Rojo/provisioning live checks were not rerun for this patch because its code neither invokes nor changes those paths; their 0.13.0 evidence remains historical.
