...
1. **T5 - Ratatui Machine Setup (0.17.0 candidate):** review-first selection, in-TUI progress/results, and cooperative stopping after the active item. Implementation, local review, and runtime CI are complete; awaiting release closeout and owner publication. [PR #26](https://github.com/chatarabdelilah/rproj/pull/26) records final-head and merged-main verification.
